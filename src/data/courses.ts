...
export const courses: Course[] = [
  ...
  { slug: 'sup-taiken', group: 'sup', name: 'はじめての体験SUPツアー', tag: 'SUP', tagline: '海の上を、ただ静かに歩く',
    ...
    highlights: ['初心者歓迎', 'ウミガメ遭遇率90%', '90分'], duration: '90分', price: '¥8,000 / 1名', duotone: 'shallow', image: '/images/courses/sup-taiken-1.jpg',
  ...
  { slug: 'yugyosen-solo', group: 'yugyosen', name: '沖釣りフィッシング体験ツアー', tag: 'FISHING', tagline: '漁師ガイドと、本気の海釣り',
    ...
    highlights: ['漁師ガイド同行', '本格船釣り', '道具レンタルあり', '4時間'], duration: '4時間', price: '¥20,000 / 1名', duotone: 'deep', image: '/images/courses/okazuri-1.jpg',
  ...
  { slug: 'yugyosen-charter', group: 'yugyosen', name: '貸切チャーターフィッシングツアー', tag: 'FISHING', tagline: '船を貸し切って、仲間と',
    ...
    highlights: ['完全貸切', 'グループ向け', '漁師ガイド同行', '4時間'], duration: '4時間', price: '¥50,000 / 貸切', duotone: 'deep', image: '/images/courses/okazuri-2.jpg',
  ...
  { slug: 'okazuri', name: '気軽に楽しむ陸釣り体験ツアー', tag: 'FISHING', tagline: '気軽に、岸から一匹',
    ...
    highlights: ['初心者・家族歓迎', '船が苦手でも', '2時間'], duration: '2時間', price: '¥6,000 / 1名', duotone: 'shallow', image: '/images/courses/okazuri-4.jpg',
